...
#endif
bool ApplyStageTitleImage(AnmVm *vm, std::uint32_t stage);
bool StageLogoImageActive();
bool ApplyMusicTitleImage(AnmVm *vm, std::uint32_t stage, std::uint32_t cue);
bool ApplyBossTitleImage(AnmVm *vm, std::uint32_t stage);
bool ApplyBossNameImage(AnmVm *vm, std::uint32_t stage);
