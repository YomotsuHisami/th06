#!/usr/bin/env python3
"""Run the TH_DEV_TOOLS ReplayExtension round-trip inside the Web runtime."""
...
def main() -> int:
        ...
        try:
            with sync_playwright() as playwright:
                ...
                while time.time() < deadline:
                    state = page.evaluate(
                        """() => ({
                          exit: globalThis.__th06ReplayExtensionSelfTestExit || '',
                          failure: globalThis.__th06ReplayExtensionSelfTestFailure || '',
                        })"""
                    )
    ...
    print("TH06 ReplayExtension browser round-trip: PASS")
    return 0
